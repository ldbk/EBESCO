...
rmarkdown::render(
  input = here("02_EXPLORE_DATA/CGFS_est_ouest_exploration_sp_scientific.Rmd"),
...
EC_shp <- vect(here("01_DATA", "shapefiles", "English_Channel_extension", "English_Channel_extension.shp"))
...
source(here('04_MODEL/functions/simulate_plot_distribution.R'))
...
plot_dist_west_biomass

```
```{r echo=FALSE, fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
plot_dist_west_density
```
<br>
...
plot_dist_east_biomass

```
```{r echo=FALSE, fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
plot_dist_east_density
```
<br>
<br>
\vspace{2cm}
